<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <div class="mt-6 flex justify-between">
            <a href="{{ route('workPrograms.index', ['slug' => $workProgram->department->slug]) }}"
                class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition">
                ← Kembali
            </a>

            <a href="{{ route('workProgram.edit', ['workProgram' => $workProgram, 'slug' => $workProgram->department->slug]) }}"
                class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">
                Edit Program
            </a>
            <form
                action="{{ route('workProgram.destroy', ['workProgram' => $workProgram, 'slug' => $workProgram->department->slug]) }}"
