<x-app-layout>
    <div class="max-w-6xl mx-auto py-8 px-4">
        ...
        <div class="flex justify-end mb-6">
            <a href="{{ route('workProgram.create', ['department' => $department, 'slug' => $department->slug]) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ($department->workPrograms as $workProgram)
                <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200 hover:shadow-xl transition">
                    ...
                    <a href="{{ route('workProgram.detail', ['workProgram' => $workProgram, 'slug' => $department->slug]) }}"
