                ...
                <div>
                    @if ($department->managing_director)
                        <div>
                            ...
                            <p class="mt-1 text-[12px] md:text-sm font-semibold text-gray-500">
                                {{ $department->managing_director->name }} - {{ $department->managing_director->email }}
                            </p>
                        </div>
                    @else
                        <span class="text-[14px] md:text-sm font-semibold text-[#14267B] ">Managing Director: -</span>
                    @endif
                </div>
